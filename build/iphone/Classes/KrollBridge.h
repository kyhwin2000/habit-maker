...
@interface habitmakerObject : KrollCoverageObject {
#else
@interface habitmakerObject : KrollObject {
#endif
@private
...
extern NSString * habitmaker$ModuleRequireFormat;
