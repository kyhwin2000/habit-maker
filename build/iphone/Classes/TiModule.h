...
/**
 The base class for all habitmaker modules
 */
...
/**
 habitmaker Platform calls this method on startup.
 */
-(void)startup;

/**
 habitmaker Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 habitmaker Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 habitmaker Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 habitmaker Platform calls this method on resume.
 @param sender The sender of the event.
 */
