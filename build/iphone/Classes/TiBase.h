...
// in simulator we redefine to format for habitmaker Developer console
...
{\
	NSString * exceptionName = [@"org.habitmaker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.habitmaker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIhabitmakerNativeItemNone = -1, 
	UIhabitmakerNativeItemSpinner = -2,
	UIhabitmakerNativeItemProgressBar = -3,
	
	UIhabitmakerNativeItemSlider = -4,
	UIhabitmakerNativeItemSwitch = -5,
	UIhabitmakerNativeItemMultiButton = -6,
	UIhabitmakerNativeItemSegmented = -7,
	
	UIhabitmakerNativeItemTextView = -8,
	UIhabitmakerNativeItemTextField = -9,
	UIhabitmakerNativeItemSearchBar = -10,
	
	UIhabitmakerNativeItemPicker = -11,
	UIhabitmakerNativeItemDatePicker = -12,
	
	UIhabitmakerNativeItemInfoLight = -13,
	UIhabitmakerNativeItemInfoDark = -14,
	
	UIhabitmakerNativeItemDisclosure = -15,
	
	UIhabitmakerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all habitmaker instances of
