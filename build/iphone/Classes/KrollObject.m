...
//@interface habitmakerObject : NSObject
//@end

@interface habitmakerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[habitmakerObject class]])
		{
			for (NSString *key in [[(habitmakerObject*)o modules] allKeys])
			{
